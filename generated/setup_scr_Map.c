...
void setup_scr_Map(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->Map, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->Map_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
