...
void setup_scr_Set(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->Set, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Set_label_1, 70, 124);
    ...
    lv_obj_set_style_text_color(ui->Set_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
