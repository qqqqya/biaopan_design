...
void setup_scr_List_1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->List_1_cont_1, 220, 391);
    ...
    lv_obj_set_size(ui->List_1_cont_2, 215, 40);
    ...
    lv_obj_set_pos(ui->List_1_img_1, 27, 2);
    ...
    lv_obj_set_pos(ui->List_1_label_2, 53, 9);
    ...
    lv_obj_set_pos(ui->List_1_cont_3, 0, 54);
    lv_obj_set_size(ui->List_1_cont_3, 215, 40);
    ...
    lv_obj_set_pos(ui->List_1_img_2, 24, 1);
    ...
    lv_obj_set_pos(ui->List_1_label_1, 59, 7);
    ...
    lv_obj_set_pos(ui->List_1_cont_4, 0, 108);
    lv_obj_set_size(ui->List_1_cont_4, 215, 40);
    ...
    lv_obj_set_pos(ui->List_1_img_3, 26, 7);
    ...
    lv_obj_set_pos(ui->List_1_label_3, 61, 9);
    ...
    lv_obj_set_pos(ui->List_1_cont_5, 0, 162);
    lv_obj_set_size(ui->List_1_cont_5, 215, 40);
    ...
    lv_obj_set_pos(ui->List_1_img_4, 27, 4);
    ...
    lv_obj_set_pos(ui->List_1_label_4, 64, 11);
    ...
    lv_obj_set_pos(ui->List_1_cont_6, 0, 216);
    lv_obj_set_size(ui->List_1_cont_6, 215, 40);
    ...
    lv_obj_set_pos(ui->List_1_img_5, 21, 2);
    ...
    lv_obj_set_pos(ui->List_1_label_5, 59, 9);
    ...
    lv_obj_set_pos(ui->List_1_cont_7, 0, 270);
    lv_obj_set_size(ui->List_1_cont_7, 215, 40);
    ...
    ui->List_1_img_7 = lv_img_create(ui->List_1_cont_7);
    lv_obj_add_flag(ui->List_1_img_7, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->List_1_img_7, &_weater32x32_alpha_30x30);
    lv_img_set_pivot(ui->List_1_img_7, 50,50);
    lv_img_set_angle(ui->List_1_img_7, 0);
    lv_obj_set_pos(ui->List_1_img_7, 22, 4);
    ...
    ui->List_1_label_7 = lv_label_create(ui->List_1_cont_7);
    lv_label_set_text(ui->List_1_label_7, "Weather\n");
    lv_label_set_long_mode(ui->List_1_label_7, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->List_1_label_7, 57, 9);
    ...
    lv_obj_set_pos(ui->List_1_cont_8, 1, 332);
    lv_obj_set_size(ui->List_1_cont_8, 215, 40);
    ...
    //Write codes List_1_img_8
    ui->List_1_img_8 = lv_img_create(ui->List_1_cont_8);
    lv_obj_add_flag(ui->List_1_img_8, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->List_1_img_8, &_set32x32_alpha_30x30);
    lv_img_set_pivot(ui->List_1_img_8, 50,50);
    lv_img_set_angle(ui->List_1_img_8, 0);
    lv_obj_set_pos(ui->List_1_img_8, 22, 4);
    lv_obj_set_size(ui->List_1_img_8, 30, 30);

    //Write style for List_1_img_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->List_1_img_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->List_1_img_8, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->List_1_img_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->List_1_img_8, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes List_1_label_8
    ui->List_1_label_8 = lv_label_create(ui->List_1_cont_8);
    lv_label_set_text(ui->List_1_label_8, "Set\n");
    lv_label_set_long_mode(ui->List_1_label_8, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->List_1_label_8, 56, 13);
    lv_obj_set_size(ui->List_1_label_8, 135, 18);

    //Write style for List_1_label_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->List_1_label_8, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->List_1_label_8, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->List_1_label_8, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->List_1_label_8, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->List_1_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->List_1_btn_2, 4, 392);
    lv_obj_set_size(ui->List_1_btn_2, 215, 40);
